      ...
      <div className="container py-14 grid gap-12 md:grid-cols-4">
        ...
        <div>
          ...
          <div className="flex gap-3">
            <a href="https://instagram.com/bepelican" aria-label="Instagram" className="p-2 rounded-full bg-secondary-foreground/10 hover:bg-primary transition-smooth">
              <Instagram className="h-4 w-4" />
            </a>
            <a href="https://facebook.com/bepelican" aria-label="Facebook" className="p-2 rounded-full bg-secondary-foreground/10 hover:bg-primary transition-smooth">
              <Facebook className="h-4 w-4" />
            </a>
            <a href="mailto:hola@bepelican.com" aria-label="Email" className="p-2 rounded-full bg-secondary-foreground/10 hover:bg-primary transition-smooth">
