...
export const EXPERIENCES: Experience[] = [
  ...
  // ---------------- SANTA MARTA ----------------
  {
    ...
    durationDays: 4,
    difficulty: "extreme",
    pace: { es: "Exigente — 47 km, ríos, calor", en: "Demanding — 47 km, rivers, heat" },
    priceCOP: 1860000,
    ...
    description: {
      es: "Explora uno de los tesoros arqueológicos más importantes de América Latina: Ciudad Perdida, una joya construida antes que Machu Picchu. Cuatro días caminando entre montañas, ríos cristalinos y selva viva, conectando con comunidades indígenas que aún conservan la sabiduría de sus ancestros. No es un viaje… es un rito. ¿Listo para responder al llamado de Teyuna?",
      en: "Explore one of Latin America's most important archaeological treasures: Ciudad Perdida, a jewel built before Machu Picchu. Four days walking through mountains, crystal-clear rivers and living jungle, connecting with indigenous communities that still preserve the wisdom of their ancestors. It's not a trip… it's a rite. Ready to answer Teyuna's call?",
    },
    insights: { es: ["47 km de trek en 4 días", "Ciudad arqueológica de Teyuna", "Encuentros con Kogui y Tayrona", "Más antigua que Machu Picchu"], en: ["47 km trek over 4 days", "Teyuna archaeological site", "Encounters with Kogui and Tayrona", "Older than Machu Picchu"] },
    ...
    details: {
      about: {
        es: "Explora uno de los tesoros arqueológicos más importantes de América Latina: Ciudad Perdida, una joya construida antes que Machu Picchu.\n\nDurante cuatro días caminarás entre montañas, cruzarás ríos cristalinos, dormirás rodeado de selva viva y te conectarás con comunidades indígenas que aún conservan la sabiduría de sus ancestros.\n\nNo es un viaje… es un rito.\n\n¿Listo para responder al llamado de Teyuna?\n\nDuración total: 4 días y 3 noches. Aproximadamente 47 km recorridos.",
        en: "Explore one of Latin America's most important archaeological treasures: Ciudad Perdida, a jewel built before Machu Picchu.\n\nFor four days you'll walk between mountains, cross crystal-clear rivers, sleep surrounded by living jungle and connect with indigenous communities that still preserve the wisdom of their ancestors.\n\nIt's not a trip… it's a rite.\n\nReady to answer Teyuna's call?\n\nTotal duration: 4 days and 3 nights. Approximately 47 km covered.",
      },
      difficultyNote: {
        es: "Exigente. Caminatas de entre 4 y 8 horas por día, terreno irregular, húmedo y resbaloso.",
        en: "Demanding. Daily hikes of 4 to 8 hours, irregular, humid and slippery terrain.",
      },
      languages: { es: "Español (otros idiomas con costo adicional)", en: "Spanish (other languages with extra cost)" },
      itinerary: [
        {
          title: {
            es: "Día 1 — Comienza la travesía: rumbo a la selva ancestral. Santa Marta → El Mamey (Machete Pelao) → Campamento Adán",
            en: "Day 1 — The journey begins: heading into the ancestral jungle. Santa Marta → El Mamey (Machete Pelao) → Adán Camp",
          },
          body: {
            es: [
              "Entre las 08:00 y 08:30 a.m. el transporte los recoge en el alojamiento del centro histórico de Santa Marta, o pueden llegar directamente a la oficina (centro histórico) a las 09:00 a.m. y dejar el equipaje innecesario.",
              "Charla previa y salida por carretera hacia El Mamey (Machete Pelao). Llegada al mediodía y almuerzo típico para cargar energías.",
              "A la 1:00 p.m. inicia la caminata por senderos selváticos: aproximadamente 9 km (~4 horas) cruzando ríos, bosques y miradores hasta el campamento.",
              "Llegada al campamento a final de la tarde. Ducha, descanso y bebidas frías disponibles. Cena al anochecer y alojamiento en camas con toldillo (o hamacas con toldillo si lo prefieres).",
            ],
            en: [
              "Between 8:00 and 8:30 a.m. transport picks you up at your historic-center hotel, or you can arrive directly at our office (historic center) at 9:00 a.m. and drop unnecessary luggage.",
              "Briefing and road transfer to El Mamey (Machete Pelao). Arrival around noon and a typical lunch to load up on energy.",
              "At 1:00 p.m. the trek begins through jungle trails: about 9 km (~4 hours) crossing rivers, forests and viewpoints to the camp.",
              "Arrival at camp by late afternoon. Shower, rest and cold drinks available. Dinner at nightfall and lodging in beds with mosquito nets (or hammocks with mosquito nets if you prefer).",
            ],
          },
        },
        {
          title: {
            es: "Día 2 — Caminos sagrados y río Buritaca. Campamento Adán → Mumake → Paraíso",
            en: "Day 2 — Sacred paths and the Buritaca River. Adán → Mumake → Paraíso Camp",
          },
          body: {
            es: [
              "5:00 a.m. café caliente y desayuno. A las 5:45 a.m. comienza la primera caminata: ~8 km (3,5–4 horas) hasta el campamento Mumake.",
              "Paradas en miradores panorámicos, puestos de artesanías indígenas y frutas frescas. Almuerzo y baño en el río Buritaca.",
              "Entre 1:00 y 2:00 p.m. retoman la caminata: otros ~8 km (3,5–4 horas) hasta los últimos campamentos antes de la Ciudad Perdida.",
              "Llegada al campamento Paraíso hacia las 6:00 p.m. Ducha, cena a las 7:00 p.m. y descanso en plena selva, a un paso de Teyuna.",
            ],
            en: [
              "5:00 a.m. hot coffee and breakfast. At 5:45 a.m. the first hike begins: ~8 km (3.5–4 hours) to Mumake camp.",
              "Stops at scenic viewpoints, indigenous craft stalls and fresh-fruit posts. Lunch and a swim in the Buritaca River.",
              "Between 1:00 and 2:00 p.m. the trek resumes: another ~8 km (3.5–4 hours) to the last camps before Ciudad Perdida.",
              "Arrival at Paraíso camp around 6:00 p.m. Shower, dinner at 7:00 p.m. and rest in the jungle, one step from Teyuna.",
            ],
          },
        },
        {
          title: {
            es: "Día 3 — Ciudad Perdida: el corazón espiritual de los Tayrona. Ciudad Perdida → Paraíso → regreso a Mumake",
            en: "Day 3 — Ciudad Perdida: the spiritual heart of the Tayrona. Ciudad Perdida → Paraíso → back to Mumake",
          },
          body: {
            es: [
              "5:30 a.m. desayuno y a las 6:00 a.m. comienza la caminata final hacia la Ciudad Perdida: ~2 km y 1 hora subiendo por escalinatas de piedra.",
              "Entre 2 y 3 horas para recorrer 3–4 km del sitio arqueológico: terrazas ceremoniales, antiguos templos, petroglifos tayronas y la explicación del guía local sobre su historia.",
              "Tiempo para contemplación, fotografías y conexión con el lugar.",
              "Hacia las 11:00 a.m. inicia el descenso al campamento Paraíso (los mismos 2 km), almuerzo cerca de las 12 y se recoge la maleta.",
              "Caminata de regreso a Mumake (~9 km, ~4 horas) llegando entre 3:30 y 4:00 p.m. Tiempo para baño en el río, cena, historias y celebración antes de dormir.",
            ],
            en: [
              "5:30 a.m. breakfast and at 6:00 a.m. the final climb to Ciudad Perdida begins: ~2 km and 1 hour up stone staircases.",
              "2 to 3 hours to walk 3–4 km of the archaeological site: ceremonial terraces, ancient temples, Tayrona petroglyphs and the local guide's history of the place.",
              "Time for contemplation, photos and connecting with the site.",
              "Around 11:00 a.m. the descent to Paraíso camp begins (the same 2 km), lunch around noon and luggage pickup.",
              "Trek back to Mumake (~9 km, ~4 hours) arriving between 3:30 and 4:00 p.m. Time to bathe in the river, dinner, stories and celebration before sleep.",
            ],
          },
        },
        {
          title: {
            es: "Día 4 — Regreso con el alma llena. Mumake → Mamey → Santa Marta",
            en: "Day 4 — Returning with a full soul. Mumake → Mamey → Santa Marta",
          },
          body: {
            es: [
              "Desayuno a las 5:30 a.m. y caminata de regreso desde las 6:00 a.m.: ~6 horas y 18 km descendentes hasta Mamey.",
              "Snack ligero hacia las 9:30 a.m. en uno de los campamentos intermedios.",
              "Llegada a Mamey al mediodía: último almuerzo y posibilidad de ducharse y cambiarse en los restaurantes locales.",
              "Hacia la 1:00 p.m. transporte de regreso a Santa Marta (3–4 horas). Llegada estimada entre 4:00 y 5:00 p.m. al hotel o a la oficina.",
            ],
            en: [
              "Breakfast at 5:30 a.m. and the return hike starts at 6:00 a.m.: ~6 hours and 18 km downhill back to Mamey.",
              "Light snack around 9:30 a.m. at one of the intermediate camps.",
              "Arrival at Mamey around noon: last lunch and the chance to shower and change at the local restaurants.",
              "Around 1:00 p.m. transport back to Santa Marta (3–4 hours). Estimated arrival between 4:00 and 5:00 p.m. at hotel or office.",
            ],
          },
        },
      ],
      includes: {
        es: [
          ...
          "Alojamiento en camarotes con toldillo (opción de hamacas con toldillo)",
        ...
        en: [
          "Full meal plan",
          "Lodging in bunks with mosquito nets (hammock with mosquito net option)",
          "Expert local guides",
      ...
      notIncluded: {
        es: [
          "Tiquetes aéreos",
          "Hospedaje en Santa Marta (tenemos convenios con hoteles 3–5 estrellas y hostales cerca de la oficina en el centro histórico)",
          "Bebidas adicionales no especificadas",
          "Propinas voluntarias",
          "Gastos personales",
          "Snacks o compras durante el recorrido",
          "Equipos personales de trekking",
        ],
        en: [
          "Flights",
          "Lodging in Santa Marta (we partner with 3–5 star hotels and hostels near our office in the historic center)",
          "Additional drinks not specified",
          "Voluntary tips",
          "Personal expenses",
          "Snacks or purchases during the trek",
          "Personal trekking gear",
        ],
      },
      meetingPoint: {
        es: "Oficina en el centro histórico de Santa Marta — Calle 21 # 3-16, local 1",
        en: "Office in the historic center of Santa Marta — Calle 21 # 3-16, local 1",
      },
      endingPoint: {
        es: "Centro histórico de Santa Marta, entre 4:00 y 5:00 p.m.",
        en: "Historic center of Santa Marta, between 4:00 and 5:00 p.m.",
      },
      startTime: "08:00",
      climate: {
        temperature: { es: "18 °C – 28 °C según la altura", en: "18 °C – 28 °C depending on elevation" },
        bestSeason: {
          es: "Mejor época: temporada seca de diciembre a marzo y de julio a agosto. Más lluvioso de abril a junio y de septiembre a noviembre.",
          en: "Best time: dry season from December to March and from July to August. Rainier from April to June and from September to November.",
        },
      },
      recommendations: {
        es: [
          "Morral ligero y cómodo de 30–40 litros",
          "Pantalones y camisas ligeras, de secado rápido",
          "Botas de trekking o tenis con buen agarre",
          "Mínimo 4 pares de medias o calcetines",
          ...
          "Efectivo (no hay cajeros)",
          "Desconexión total: la señal es muy limitada",
        ],
        en: [
          "Light, comfortable 30–40 L backpack",
          "Light, quick-dry pants and shirts",
          "Trekking boots or shoes with good grip",
          "At least 4 pairs of socks",
          "Sandals to rest your feet",
          "Towel and swimwear",
          ...
          "Full disconnection: signal is very limited",
        ],
      },
      cancellation: {
        es: "Reserva: anticipo del 15% del valor total para confirmar cupo (guías locales, seguro obligatorio, campamentos y permisos). El saldo se paga en oficina en Santa Marta antes de iniciar. Reserva con mínimo 12 horas según disponibilidad.\n\nCancelación: con 48 horas de anticipación, el 10% no es reembolsable ni transferible a otra persona, pero sí permite cambiar la fecha. Ese 10% corresponde al gasto operativo y de reserva.",
        en: "Booking: 15% deposit of the total to confirm your spot (local guides, mandatory insurance, camps and permits). The balance is paid at the Santa Marta office before starting. Book at least 12 hours in advance subject to availability.\n\nCancellation: with 48 hours' notice, 10% is non-refundable and non-transferable, but you can change the date. That 10% covers operational and booking costs.",
      },
    },
  },
  {
